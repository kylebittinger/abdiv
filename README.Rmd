...
"$\alpha$-diversity" means the diversity within a single sample.
...
In our documentation, you can find more info on each $\alpha$-diversity
function.
...
As before, you can find more info on each $\beta$-diversity function in our documentation.

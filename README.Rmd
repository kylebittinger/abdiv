...
like the figure, we use `ape::rotateConstr()` to arrange the tips of the tree
...
to be 5 + 4 + 2 + 4 + 1 + 20 + 5 + 1 + 3 = 45, adding from top to bottom.^[In
...
UniFrac distance. We've stored the tree from Figure 1 in our package files
under `extdata/unifrac_paper.tre`, so we'll load it from there.
